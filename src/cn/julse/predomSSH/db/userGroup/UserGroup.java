...
public class UserGroup {
	 ...
	 */
	public String getUsergroup_note() {
		return usergroup_note;
	}
	/**
	 * @param usergroup_note the usergroup_note to set
	 */
	public void setUsergroup_note(String usergroup_note) {
		this.usergroup_note = usergroup_note;
	}
